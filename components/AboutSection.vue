<template>
    <div class="about">
      <SectionBody class="about__body" title="About Me">
        ...
        <p>I'm Maksym Hulhevych, I'm an avid learner with a strong passion for Web & Game Development and Software.</p>
...
export default {
  data: function() {
    return {
      skills: [
        { icon: 'devicon-c-plain', name: 'C/C++' },
        { icon: 'devicon-unity-plain', name: 'Unity' },
        { icon: 'devicon-csharp-plain', name: 'C#' },
        { icon: 'devicon-unrealengine-original', name: 'Unreal Engine 4' },
        { icon: 'devicon-graphql-plain', name: 'GraphQL' },
        { icon: 'devicon-lua-plain', name: 'Lua' },
        ...
        { icon: 'devicon-aftereffects-plain', name: 'After Effects' },
        { icon: 'devicon-premierepro-plain', name: 'Premiere Pro' },
        { icon: 'devicon-maya-plain', name: 'Maya' },
        ...
        { icon: 'devicon-dot-net-plain', name: 'ASP.NET' },
      ]
    }
  },
